...
public class LightsOutButton extends JButton {
	...
	public LightsOutButton(int rowNumber, int colNumber) { 
		...
		column = colNumber;
		isOn = false;
		ImageIcon offImage = new ImageIcon("/Users/nicholaskroop/eclipse-workspace/CS1410/src/assign09/off.png");
		...
		ImageIcon onImage = new ImageIcon("/Users/nicholaskroop/eclipse-workspace/CS1410/src/assign09/on.png");
